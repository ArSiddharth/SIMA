...
urlpatterns = [
    ...
    path("api/items/<int:pk>", views.item_json, name="item-json"),

    # Delivery URLs
    path("deliveries/<int:pk>/invoice", views.delivery_invoice_download, name="delivery-invoice"),
    path(
        'deliveries/',
        DeliveryListView.as_view(),
        name='deliveries'
    ),
    # path("deliveries/search/", views.DeliverySearchListView.as_view(), name="deliveries-search"),
